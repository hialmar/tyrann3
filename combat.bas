...
7070 IF A$="1" THEN LOAD"COMBAT"
7080 CLS:PRINT@15,5;"Coward !":ZAP:END 
...
8700 REM CHOIX
8720 PRINT@30,9;CHR$(145)"ACTION "CHR$(144)
8730 IF WR(P)=0 AND WL(P)=0 AND BT(P)=0 THEN ARM=0 ELSE ARM=1
8740 IF ARM=1 THEN PRINT@30,11;CHR$(131)"A)TTACK"
8750 IF OP(P)>0 THEN PRINT@30,12;CHR$(131)"U)SE ITEM"
8760 PRINT@30,13;CHR$(131)"P)ARRY"
8770 IF CP(P)>3 THEN PRINT@30,14;CHR$(131)"S)PELL"
8800 GET A$
...
20200 S$="A special prime of"+STR$(PRI)+" ss":L=14:GOSUB 300:WAITTI*12
...
20250 NEXT P
20260 L=18:S$="DECAMP NOW !":GOSUB 300
20270 L=21:GOSUB 400
20280 PING
20290 POKE AD,X:POKE AD+1,Y:POKEAD+2,S:POKE AD+5,NF
20300 GOSUB 49000:LOAD"LABY"
