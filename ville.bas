...
8800 IFCH<7THENPX=PR%(SA(P,CH)):GOSUB8900:SA(P,CH)=0:GOSUB8920:GOTO8850
...
52000 DATA "sangsue royale","fleur de Lys","encre de poulpe","rose du Val","huile du Roc","foie de truite"
